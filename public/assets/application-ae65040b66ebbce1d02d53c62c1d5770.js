...
(function() {
  ...
  mifd_dialog = function(id, ok, cancel) {
    return $(id).dialog(ok, cancel)(function() {
      return {
        resizable: false,
        height: 180,
        modal: true,
...
(function() {
  ...
  Mifd.Models.Tweet = (function(_super) {
...
(function() {
  ...
  Mifd.Models.User = (function(_super) {
    ...
    User.prototype.initialize = function(tweetUser) {};
...
(function() {
  ...
  Mifd.Models.UserTweet = (function(_super) {
    __extends(UserTweet, _super);

    function UserTweet() {
      _ref = UserTweet.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    UserTweet.prototype.initialize = function() {};

    UserTweet.prototype.url = '/api/v1/user_tweets';
...
(function() {
  ...
  Mifd.Collections.Tweets = (function(_super) {
    ...
    Tweets.prototype.model = Mifd.Models.Tweet;

    Tweets.prototype.initialize = function() {};

    Tweets.prototype.url = '/api/v1/tweets';
...
(function() {
  ...
  Mifd.Collections.Users = (function(_super) {
    ...
    Users.prototype.model = Mifd.Models.User;
...
(function() {
  ...
  Mifd.Views.TweetsIndex = (function(_super) {
    ...
    TweetsIndex.prototype.el = 'body';

    TweetsIndex.prototype.events = {
    ...
    TweetsIndex.prototype.initialize = function() {
      $("img").error(function() {
        return $(this).attr("src", "/assets/designer.jpg");
      });
      return (function() {
        $("div.selectBox").each(function() {
          ...
          that.children("span.selected,span.selectArrow").click(function() {
            that = $(this);
            if (that.parent().children("div.selectOptions").css("display") === "none") {
              that.parent().children("div.selectOptions").css("display", "block");
            } else {
              that.parent().children("div.selectOptions").css("display", "none");
            }
          });
          that.find("span.selectOption").click(function() {
            that = $(this);
    ...
    TweetsIndex.prototype.user_profile = function(event) {
      var template, tweet;
      $("#spinner,#modal").css("display", "block");
      tweet = this.collection.at($(event.currentTarget).parents('.content').parent('li').index());
      template = _.template('http://' + document.location.host + "/users/<%= uuid %>");
      return Backbone.ajax({
        type: 'get',
        dataType: 'html',
        url: template({
          uuid: tweet.attributes.user.uuid
        }),
        success: function(html) {
          ...
          return $("<div></div>").html(html).dialog({
            ...
            open: function() {
              $("#right-side *").blur();
              return window.Mifd.Routers.router.profile();
            }
          });
        }
      });
    ...
    TweetsIndex.prototype.mifd_dialog = function(id, ok, cancel) {
      return $(id).dialog({
        resizable: false,
        height: 180,
        modal: true,
    ...
    TweetsIndex.prototype.is_login = function() {
      return this.mifd_dialog("#dialog-confirm", (function() {
        ceres.CK.set('referer', encodeURI(document.URL));
        return location.href = "/auth/twitter";
      }));
    };

    TweetsIndex.prototype.login = function(event) {
      event.preventDefault();
      return this.is_login();
    };

    TweetsIndex.prototype.already_request = function() {
      return this.mifd_dialog("#dialog-already", function(that) {
        return that.dialog.call(that, "close");
      });
    };

    TweetsIndex.prototype.tweet_action = function(event) {
      var chk, index, that, tweet, user_tweet;
      event.preventDefault();
      that = this;
      if (!gon.current_user) {
        return this.is_login();
        ...
        tweet = this.collection.at(index);
        chk = ($(event.currentTarget).attr("class") === "retweet" ? "is_retweet" : "is_favorite");
        if (!tweet.get(chk)) {
          user_tweet = new Mifd.Models.UserTweet({
            user_desc: gon.current_user.screen_name,
            type: ($(event.currentTarget).attr("class") === "retweet" ? "R" : "F"),
            tweet_uuid: tweet.get('uuid')
          });
          $("#spinner,#modal").css("display", "block");
          return user_tweet.save(null, {
            success: function(model, response) {
              ...
              if (Number(response.result)) {
                ...
                return that.mifd_dialog("#dialog-success", function(that) {
                  return that.dialog.call(that, "close");
                });
              } else {
...
(function() {
  ...
  Mifd.Views.Show = (function(_super) {
    ...
    Show.prototype.follow = function() {
      if (!gon.current_user) {
        if (confirm("트위터 로그인 하시겠습니까?")) {
          location.href = "/auth/twitter";
        }
      } else {
        return this.collection.follow();
      }
    };
...
(function() {
  ...
  Mifd.Routers.Tweets = (function(_super) {
    __extends(Tweets, _super);
    ...
    Tweets.prototype.routes = {
      '': 'index',
      'categories/:id': 'category'
    };

    Tweets.prototype.index = function() {
      return new Mifd.Views.TweetsIndex({
        collection: new Mifd.Collections.Tweets(gon.tweets)
      });
    };

    Tweets.prototype.category = function() {
      return new Mifd.Views.TweetsIndex({
        collection: new Mifd.Collections.Tweets(gon.tweets)
      });
    };

    Tweets.prototype.profile = function() {
      if (!_.isUndefined(window.Mifd.Views.show)) {
        window.Mifd.Views.show.remove();
      }
      return window.Mifd.Views.show = new Mifd.Views.Show({
        collection: new Mifd.Collections.Users([gon.tweet_user, (_.isNull(gon.current_user) ? {} : gon.current_user)])
      });
    };
